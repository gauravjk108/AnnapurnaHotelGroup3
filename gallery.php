...
<body>
    ...
    <div class="container d-flex align-items-center">
      ...
      <nav id="navbar" class="navbar order-last order-lg-0">
        <ul>
          ...
          <li class="dropdown"><a class="active" href="#"><span>Events and Gallery</span> <i class="bi bi-chevron-down"></i></a>
            <ul>
  ...
  <main id="main">
    ...
    <div class="breadcrumbs" data-aos="fade-in">
      <div class="container">
        <h2>Gallery</h2>
        <p>Some glimpses of amazing events in our hotel.</p>
      </div>
    </div><!-- End Breadcrumbs -->
    

    <div id="gallery" class="row" class="carousel slide" data-bs-ride="carousel"> 
        <!-- Carousel indicators -->
