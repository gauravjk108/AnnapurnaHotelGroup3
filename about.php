      ...
      <div class="container" data-aos="fade-up">
        ...
        <div class="row">
          ...
          <div class="col-lg-6 pt-4 pt-lg-0 order-2 order-lg-1 content">
            <h3>50+ years of service and customer satisfaction.</h3>
            <p class="fst-italic">
              Established in 1965 as "Hotel de l' Annapurna", we aim to provide our guests with thebest 5-star experience in the country.
            </p>
            <ul>
              <li><i class="bi bi-check-circle"></i> Well-trained hotel staff.</li>
              <li><i class="bi bi-check-circle"></i> Banquet Halls.</li>
              <li><i class="bi bi-check-circle"></i> Swimming Pool.</li>
              <li><i class="bi bi-check-circle"></i> 5-star Presidential Suite.</li>
            </ul>
            <p>
              Please give us a chance for your hospitality.
            </p>
      ...
      <div class="container">
        ...
        <div class="row counters">
          ...
          <div class="col-lg-3 col-6 text-center">
            <span data-purecounter-start="0" data-purecounter-end="149" data-purecounter-duration="1"
          ...
          <div class="col-lg-3 col-6 text-center">
            <span data-purecounter-start="0" data-purecounter-end="300000" data-purecounter-duration="1"
              class="purecounter"></span>
            <p>and more Satisfied Customers</p>
          </div>
