...
<head>
    ...
    <title>Booking Form | Annapurna Hotel</title>
    ...
    <main id="main">
        ...
        <div class="breadcrumbs" data-aos="fade-in">
            <div class="container">
                ...
                <p>Please fill the following form to proceed with your booking.</p>
            </div>
        </div><!-- End Breadcrumbs -->
        <section id="contact" class="contact">
            ...
            <div class="container" data-aos="fade-up">
                ...
                <form action="bookform.php" method="post" role="form" class="php-email-form">
                    <div class="row mt-5">
                        ...
                        <div class="col-lg-4">
                            <div class="row">
                                ...
                                <div class="col-md-9 form-group">
                                    <p>Check Out:</p> 
                                    <input type="date" name="checkout" id="checkout" class="form-control" value="2020-01-01" required />
                                </div>

                                <div class="col-md-9 form-group mt-3">
                                    <input type="number" class="form-control" name="guestnum" id="guestnum" placeholder="How many guests?" required/>
                                </div>
                        ...
                        <div class="col-lg-8 mt-5 mt-lg-0">
                            ...
                            <div class="form-group mt-3">
                                <label for="suite">Choose your suite:</label>
                                <select name="suite" id="suite" class="form-control">
                                    <option value="presidential-suite">Presidential Suite</option>
                                    <option value="executive-suite">Regency Executive Suite</option>
                                    <option value="king-suite">Regency King Suite</option>
                                  </select>
                            </div>
                            <div class="my-3">
