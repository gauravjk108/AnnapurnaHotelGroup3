...
<?php 
    ...
    if(isset($_GET['del'])){
        $del = $_GET['del'];
        $q = "DELETE FROM contactinfo WHERE contactinfo.id = $del";
                ...
                <ul>
                    ...
                    <li class="dropdown"><a class="active" href="#"><span>Form Information</span><i class="bi bi-chevron-down"></i></a>
                        <ul>
                          ...
                          <li><a class="active" href="contact-details.php">Contact Details</a></li>
    ...
    <main>
        <div class="breadcrumbs" data-aos="fade-in">
            <div class="container">
              ...
              <p>Follwing user wanted to hear from you.</p>
              </div>
          </div>
          <section>
                    <div class="container">
                                ...
                                <div class="card">
                                    <div class="container" data-aos="fade-up">
                                        <table class="table">
                                            ...
                                            <tbody>
                                                 <?php
                                                    $q = "SELECT * FROM contactinfo ORDER BY contactinfo.id ASC";
                                                    $run = mysqli_query($conn, $q);
                                                ...
                                                <tr>
                                                    ...
                                                    <td><center><a href="contact-details.php?del=<?php echo $row['id']; ?>"><i class="ri-delete-bin-line"></i></a></center></td>
                                                    </tr>
                                                 <?php
                                                         }
                                                    }
