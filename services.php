...
<body>
  ...
  <main id="main">
    ...
    <div class="breadcrumbs" data-aos="fade-in">
      <div class="container">
        <h2>Our Services</h2>
        <p>Following are our offerings. Please have a look and see what you like. We hope to serve you to your utmost delight.</p>
      </div>
    </div><!-- End Breadcrumbs -->
        ...
        <div class="row" data-aos="zoom-in" data-aos-delay="100">
          <div class="col-lg-4 col-md-6 d-flex align-items-stretch">
            <div class="course-item">
              <img src="assets/img/sauna.jpg" class="img-fluid" alt="...">
              <div class="course-content">
                <div class="d-flex justify-content-between align-items-center mb-3">
                  <h4>Members only</h4>
                </div>
                <h3>Sauna</h3>
                <p>Our sauna is equipped with all the necessary amneties and can house 4 people in one of 8 rooms at a time. You need a membership for accessing it.</p>
              </div>
            </div>
          </div> <!-- End Service Item-->
          <div class="col-lg-4 col-md-6 d-flex align-items-stretch">
            <div class="course-item">
              <img src="assets/img/spa.jpg" class="img-fluid" alt="...">
              <div class="course-content">
                <div class="d-flex justify-content-between align-items-center mb-3">
                  <h4>Members only</h4>
                </div>
                <h3>Spa</h3>
                <p>Our spa offers all the types of therapatic as well as physical relaxation procedures. It is also exclusive to the members.</p>
              </div>
            </div>
          </div> <!-- End Service Item-->
          <div class="col-lg-4 col-md-6 d-flex align-items-stretch">
            <div class="course-item">
              <img src="assets/img/gym.jpg" class="img-fluid" alt="...">
              <div class="course-content">
                <div class="d-flex justify-content-between align-items-center mb-3">
                  <h4>Members only</h4>
                </div>
                <h3>Gym</h3>
                <p>We offer the best gym services in the town with the best equipments, international trainer and diet necessities.</p>
              </div>
            </div>
          </div> <!-- End Service Item-->
          <div class="col-lg-4 col-md-6 d-flex align-items-stretch">
            <div class="course-item">
              <img src="assets/img/swim.jpg" class="img-fluid" alt="...">
              <div class="course-content">
                <div class="d-flex justify-content-between align-items-center mb-3">
                  <h4>Public access</h4>
                </div>
                <h3>Swimming Pool</h3>
                <p>Tired of breaking sweat? Enjoy a day at the poolside under the sun. Hope you have a good time.</p>
              </div>
            </div>
          </div> <!-- End Service Item-->
          <div class="col-lg-4 col-md-6 d-flex align-items-stretch">
            <div class="course-item">
              <img src="assets/img/poolandsnooker.jpg" class="img-fluid" alt="...">
              <div class="course-content">
                <div class="d-flex justify-content-between align-items-center mb-3">
                  <h4>Public access</h4>
                </div>
                <h3>Pool and Snooker</h3>
                <p>Only the people who play know the fun of play. Experience the best ambience and feel of playing pool and snookers with us.</p>
              </div>
            </div>
          </div> <!-- End Service Item-->
          <div class="col-lg-4 col-md-6 d-flex align-items-stretch">
            <div class="course-item">
              <img src="assets/img/casino.jpg" class="img-fluid" alt="...">
              <div class="course-content">
                <div class="d-flex justify-content-between align-items-center mb-3">
                  <h4>VIP only</h4>
                </div>
                <h3>Casino</h3>
                <p>Exclusive to VIPs.</p>
              </div>
            </div>
          </div> <!-- End Service Item-->
